export const cultures = [
  {
    name: "Mujahadah",
    summary: `Mujahadah dapat dipahami sebagai tindakan bersungguh-sungguh memerangi hawa nafsu atau mujahadah an-nafs. Apa arti mujahadah an nafs? Secara singkat, arti mujahadah an nafs dapat dipahami sebagai kesungguhan untuk melawan hawa nafsu dan menghindari segala perilaku yang dilarang Allah SWT.
    ...
    thumbnail: "/img/dokumentasi/mujahadah1.jpg"
  },
  {
    name: "Yasinan",
  ...
  {
    name: "Jathilan",
    summary: `Jathilan adalah kesenian tradisional yang populer di Dusun Gebang, berupa tarian yang menggambarkan prajurit berkuda dan dilakukan secara berkelompok menggunakan kuda kepang (kuda tiruan dari anyaman bambu). Pertunjukan ini biasanya diiringi dengan musik gamelan dan tembang Jawa yang dinamis dan penuh semangat. Selain sebagai hiburan rakyat, jathilan juga memiliki unsur spiritual dan magis. Dalam beberapa pertunjukan, penari dapat mengalami kondisi trance atau kerasukan, yang dipercaya sebagai bentuk keterhubungan dengan dunia leluhur atau kekuatan gaib.`,
    thumbnail: "/img/dokumentasi/jathilan.jpg"
  },
  {
    name: "Karawitan",
